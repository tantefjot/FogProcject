...
//private int carportHeigth;
//private int stolpe_højde;
//private int lægte_Længde;
//private int sternBræde_Længde;
...
//private double totalprice;
    ...
    public Carport(String carportName, int carportWidth, int carportLength, int carportHeight, int stolpe_højde, int spær_Længde, int carport_id, int reglar_længde, int lægte_længde, int sternBrædt_Længde, int Vindskede_længde, int Rem, int skruer, int taghældning, double totalprice, int rem_længde, int tag_bredde, int tag_højde, int tag_udhæng, int gavl_bræt_længde, int gavl_bræt_højde, int gavl_bræt_bredde) {
