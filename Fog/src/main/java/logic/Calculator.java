...
//    }
    ...
    public void calculatoSkruer(Carport c){
        int skruer = 0;
        int totalStruer = skruer * 6;
        
  }
    
    public void calculatoreglar(){
        
    }
    public void calculatorem(){
        
    }
    
    public void calculatorspær(){
